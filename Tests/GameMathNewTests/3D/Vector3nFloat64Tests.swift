...
final class Vector3nFloat64Tests: XCTestCase {
    func testInit() {
    ...
    func testCross() {
        ...
        XCTAssertEqual(result.x, lhs.y * rhs.z - lhs.z * rhs.y, accuracy: .accuracy)
        XCTAssertEqual(result.y, lhs.z * rhs.x - lhs.x * rhs.z, accuracy: .accuracy)
        XCTAssertEqual(result.z, lhs.x * rhs.y - lhs.y * rhs.x, accuracy: .accuracy)
    }
