...
fileprivate typealias Scalar = UInt16
...
final class Vector3nUInt16Tests: XCTestCase {
    func testInit() {
    ...
    func testMul() {
        let x: Scalar = .random(in: 0 ... 127)
        let y: Scalar = .random(in: 0 ... 127)
        let z: Scalar = .random(in: 0 ... 127)
