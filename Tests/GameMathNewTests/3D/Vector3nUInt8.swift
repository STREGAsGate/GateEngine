...
fileprivate typealias Scalar = UInt8
...
final class Vector3nUInt8Tests: XCTestCase {
    func testInit() {
    ...
    func testDiv() {
        var x: Scalar = 0
        while x == 0 {x = .random(in: 0 ... 127)}
        var y: Scalar = 0
        while y == 0 {y = .random(in: 0 ... 127)}
        var z: Scalar = 0
        while z == 0 {z = .random(in: 0 ... 127)}
    ...
    func testDot() {
        let lhs = Imposter3(x: .random(in: 0 ... 6), y: .random(in: 0 ... 6), z: .random(in: 0 ... 6))
        let rhs = Imposter3(x: .random(in: 0 ... 6), y: .random(in: 0 ... 6), z: .random(in: 0 ... 6))
