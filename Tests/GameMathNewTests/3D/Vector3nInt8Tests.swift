...
final class Vector3nInt8Tests: XCTestCase {
    func testInit() {
    ...
    func testMul() {
        let x: Scalar = .random(in: -8 ... 8)
        let y: Scalar = .random(in: -8 ... 8)
        let z: Scalar = .random(in: -8 ... 8)
    ...
    func testDiv() {
        var x: Scalar = 0
        while x == 0 {x = .random(in: -128 ... 127)}
        var y: Scalar = 0
        while y == 0 {y = .random(in: -128 ... 127)}
        var z: Scalar = 0
        while z == 0 {z = .random(in: -128 ... 127)}
    ...
    func testDot() {
        let lhs = Imposter3(x: .random(in: -8 ... 8), y: .random(in: -8 ... 8), z: .random(in: -8 ... 8))
        let rhs = Imposter3(x: .random(in: -8 ... 8), y: .random(in: -8 ... 8), z: .random(in: -8 ... 8))
