...
final class GravityExtendingTests: GateEngineXCTestCase {
    ...
    func testHostRunClientClosure() throws {
        ...
        try gravity.compile(source: "func myFunction(randomValue) {return randomValue}; func main() {}")
        try gravity.runMain()
    ...
    func testClientRunHostClosure() throws {
        ...
        try gravity.compile(source: "extern func myFunction() {}; func main() {return myFunction()}")
        let result = try gravity.runMain()
        XCTAssertEqual(result.getInt(), randomValue)
    }
    
    func testHostGetClientInstance() throws {
        try gravity.compile(source: "class TheThing {}; var theThing = TheThing(); func main() {}")
        try gravity.runMain()
    ...
    func testHostGetClientInstanceVar() throws {
        try gravity.compile(source: "class TheThing {var myVar1; func myFunc(randomValue) { return randomValue}; var myVar2;}; var theThing = TheThing(); func main() {theThing.myVar2 = \(randomValue); theThing.myVar1 = 33}")
        try gravity.runMain()
    ...
    func testHostRunClientInstanceClosure() throws {
        let gValue = gravity.createValue(randomValue)
        try gravity.compile(source: "class TheThing {func myFunc(randomValue) {return randomValue}}; var theThing = TheThing(); func main() {}")
        try gravity.runMain()
    ...
    func testHostCreateClientClass() throws {
        ...
        try gravity.compile(source: "extern class TheThing; var theThing = TheThing(); func main() {}")
        try gravity.runMain()
