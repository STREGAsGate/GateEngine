...
public struct D3DStreamOutputDeclarationEntry {
    ...
    - parmaeter componentIndex: The component of the entry to begin writing out to. Valid values are 0 to 3. For example, if you only wish to output to the y and z components of a position, StartComponent is 1 and ComponentCount is 2.
