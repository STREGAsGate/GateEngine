...
public struct GamePadSymbol: CustomStringConvertible {
    ...
    public var localizedName: String {
        ...
        case .up, .down, .left, .right:
            fallthrough
        case .start, .select, .back, .guide, .options, .share, .home, .capture:
            fallthrough
        case .plus, .minus:
            fallthrough
...
@MainActor public class GamePad {
    ...
    @MainActor public class Buttons {
        ...
        public var confirmButton: ButtonState {
            get {return self[keyPath: confirmButtonPath]}
        }
        ...
        public var denyButton: ButtonState {
            get {return self[keyPath: denyButtonPath]}
        }
    ...
    @MainActor public class Shoulders {
        ...
        public private(set) lazy var left: ButtonState = ButtonState(gamePad: gamePad, id: .leftShoulder)
        public private(set) lazy var right: ButtonState = ButtonState(gamePad: gamePad, id: .rightShoulder)
    ...
    @MainActor public class Triggers {
        ...
        public private(set) lazy var left: ButtonState = ButtonState(gamePad: gamePad, id: .leftTrigger)
        public private(set) lazy var right: ButtonState = ButtonState(gamePad: gamePad, id: .rightTrigger)
    ...
    @MainActor public class Menu {
        ...
        public private(set) lazy var primary: ButtonState = ButtonState(gamePad: gamePad, id: .menu1)
        public private(set) lazy var secondary: ButtonState = ButtonState(gamePad: gamePad, id: .menu2)
        public private(set) lazy var tertiary: ButtonState = ButtonState(gamePad: gamePad, id: .menu3)
    ...
    public var anyButtonIsPressed: Bool {
        return dpad.isPressed || button.isPressed || shoulder.isPressed || trigger.isPressed || stick.isPressed || menu.isPressed
    }
