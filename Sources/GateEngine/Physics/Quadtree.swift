...
public final class Quadtree {
    ...
    public func colliders(hitBy ray: Ray2D, inLayer layer: String) -> [(
        point: Position2, collider: any Collider2D
    )] {
    ...
    public func colliders(at position: Position2, depth: Int, inLayer layer: String)
        -> [any Collider2D]?
    {
...
extension Quadtree {
    final class Node {
        ...
        func collidersHit(by ray: Ray2D, inLayer layer: String) -> [(
            point: Position2, collider: any Collider2D
        )] {
