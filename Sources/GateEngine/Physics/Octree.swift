...
public final class Octree: Codable {
    ...
    public func trianglesNear(_ box: AxisAlignedBoundingBox3D, visibleTo frustum: ViewFrustum3D? = nil) -> [CollisionTriangle] {
    ...
    internal func boxesVisibleTo(_ frustum: ViewFrustum3D, leafOnly: Bool) -> [AxisAlignedBoundingBox3D] {
...
extension Octree {
    struct Node: Codable {
        ...
        @inline(__always)
        func childrenNear(_ box: AxisAlignedBoundingBox3D, visibleTo frustum: ViewFrustum3D?) -> [Node]? {
